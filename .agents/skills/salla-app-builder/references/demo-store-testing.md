...
(the blog is a JS-rendered SPA; content captured here). For MCP-driven install + live
checks, see the `salla-live-testing` skill — this covers the manual Portal + webhook.site
flow.
