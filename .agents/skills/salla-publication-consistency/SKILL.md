...
6. **Validate + save the draft** (`action=validate`). On **422**, `set` the missing sections
   ...
   **Then user-confirm:** ask the partner to confirm the handlers are **deployed and tested** —
   provision on `started`,
