...
# Salla App Builder — Master Router
...
| Type          | Delta                                                                                                                           |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| General       | Needs `sub_category_id` → [salla-create-app](../salla-create-app/SKILL.md)                                                      |
...
| Intent                                                             | Skill                                                          |
| ------------------------------------------------------------------ | -------------------------------------------------------------- |
| Create / configure / publish an app end to end                     | [salla-create-app](../salla-create-app/SKILL.md)               |
...
| Docs index (LLM-readable)      | https://docs.salla.dev/llms.txt |
